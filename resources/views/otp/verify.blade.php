...
<head>
    ...
    <title>Masukkan Kode OTP – STEVA</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-subtitle .highlight { font-weight: 700; color: #800020; }
        ...
        .resend-section a {
            color: #800020; font-weight: 700; text-decoration: none;
        }
...
<a href="{{ route('otp.send.form') }}" class="btn-back-floating">
...
<div class="auth-card">
    ...
    <div class="card-body">
        ...
        <p class="card-subtitle">
            ...
            <span class="highlight">{{ session('otp_email', 'email Anda') }}</span>.
        ...
        <form method="POST" action="{{ route('otp.verify') }}" id="otpVerifyForm">
            @csrf

            {{-- OTP digits UI --}}
            <div class="otp-input-group" id="otpDigitsContainer">
                <input class="otp-digit {{ $errors->has('otp_code') ? 'is-invalid' : '' }}" type="text" inputmode="numeric" maxlength="1" data-index="0" id="otp_d0" autocomplete="off">
                <input class="otp-digit {{ $errors->has('otp_code') ? 'is-invalid' : '' }}" type="text" inputmode="numeric" maxlength="1" data-index="1" id="otp_d1" autocomplete="off">
                <input class="otp-digit {{ $errors->has('otp_code') ? 'is-invalid' : '' }}" type="text" inputmode="numeric" maxlength="1" data-index="2" id="otp_d2" autocomplete="off">
                <input class="otp-digit {{ $errors->has('otp_code') ? 'is-invalid' : '' }}" type="text" inputmode="numeric" maxlength="1" data-index="3" id="otp_d3" autocomplete="off">
                <input class="otp-digit {{ $errors->has('otp_code') ? 'is-invalid' : '' }}" type="text" inputmode="numeric" maxlength="1" data-index="4" id="otp_d4" autocomplete="off">
                <input class="otp-digit {{ $errors->has('otp_code') ? 'is-invalid' : '' }}" type="text" inputmode="numeric" maxlength="1" data-index="5" id="otp_d5" autocomplete="off">
            </div>
        ...
        <div class="resend-section">
            Tidak menerima kode?
            <a href="{{ route('otp.send.form') }}">Kirim ulang OTP</a>
        </div>
    </div>
</div>
